package com.zhaofukai.thinkinjava.generics;//: generics/WatercolorSets.java

import com.zhaofukai.thinkinjava.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static com.zhaofukai.thinkinjava.generics.watercolors.Watercolors.*;
import static com.zhaofukai.thinkinjava.net.util.Print.print;
import static com.zhaofukai.thinkinjava.net.util.Sets.*;
