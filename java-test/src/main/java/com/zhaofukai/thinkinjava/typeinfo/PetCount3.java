package com.zhaofukai.thinkinjava.typeinfo;//: typeinfo/PetCount3.java
// Using isInstance()

import com.zhaofukai.thinkinjava.net.util.MapData;
import com.zhaofukai.thinkinjava.typeinfo.pets.LiteralPetCreator;
